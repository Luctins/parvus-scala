...
def run_async_server():
    ...
    identity.VendorUrl = 'https://github.com/Luctins/parvus-scala'
    identity.ProductName = 'Parvus modbus Server'
    identity.ModelName = 'Parvus modbus Server'
    ...
    StartTcpServer(context, identity=identity, address=("25.122.166.226", 502),
